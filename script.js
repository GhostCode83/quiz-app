const STORE = [
  {
    ...
    image: '<img src="images/question-page/frank-amy-waiting-room.jpg" alt="frank-and-amy-in-waiting-room" width="500">'
    ,
    options: [
      'a bar',
      'a barbershop',
  ...
  },
  {
    ...
    image: '<img src="images/question-page/frank-arrested.jpg" alt="frank-mugshot" width="500">',
  ...
  },
  {
    ...
    image: '<img  src="images/question-page/bounty-hunters.gif" alt="bounty-hunters-agains-frank" width="500">',
    options: [
      '$5 Billion',
      '$5 Thousand',
      '$5 Hundred Thousand',
  ...
  },
  {
    ...
    image: '<img  src="images/question-page/krista-young.png" alt="krista-sad-as-child-on-floor" width="500">',
    options: [
      'Heart Attack',
  ...
  },
  {
    ...
    image: '<img  src="images/question-page/krista-offers-madani-accepts-drink.jpg" alt="krista-offers-madani-accepts-drink" width="500">',
    options: [
      'To chat about Russo',
...
function displayQuestionPage() {
  ...
  if (currentQuestion < STORE.length) {
    return `<form class="question js-question group"> 
              <h2> 
...
function displayFeedbackPage() {
  ...
  if (STORE[currentQuestion].correct) {
    ...
    <p>Points earned: ${ score}</p>
    <button class="feedback-page">Next Question</button>
    </form>`
  } else {
    return `<form class="js-feedback-page"> 
    <h2>Wrong answer!</h2>
